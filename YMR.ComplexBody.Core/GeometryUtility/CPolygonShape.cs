	...
	public class CPolygonShape
	{
	   ...
	   ******************************************************/
		...
		**********************************************************/
		...
		{
            List<CPoint2D> alTempPts = new List<CPoint2D>();
		...
		*******************************************************/
		public void CutEar()
		{
            ...
            int maxCicles = m_aInputVertices.Length * m_aInputVertices.Length; // YMR - Just in case...
            int cicle = 0;

			while (bFinish==false && cicle++ < maxCicles) //UpdatedPolygon
			{
				int i=0;
				bool bNotFound=true;
				while (bNotFound 
